...
# the file inside the ZIP a sensible name when the canonical S3 key
        ...
        for study in readable_studies:
            ...
            for n, series in enumerate(series_rows, start=1):
                ...
                work.append(
                    {
                        "kind": "bytes",
                        "name": f"studies/{study.id}/series_{n}/manifest.json",
    ...
    if "reports" in includes:
        ...
        for rep in report_rows:
            ...
            entry: dict[str, Any] = {
                ...
                "created_at": rep.created_at.isoformat(),
                "updated_at": rep.updated_at.isoformat(),
                "narrative_path": f"reports/{rep.id}.md",
            }
            work.append(
                {
                    "kind": "bytes",
                    "name": f"reports/{rep.id}.md",
            ...
            if rep.findings_md:
                ...
                work.append(
                    {
                        "kind": "bytes",
                        "name": f"reports/{rep.id}.findings.md",
            ...
            if rep.recommendations_md:
                ...
                work.append(
                    {
                        "kind": "bytes",
                        "name": f"reports/{rep.id}.recommendations.md",
