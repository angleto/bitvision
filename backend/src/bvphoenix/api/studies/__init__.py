...
from bvphoenix.api.studies import phase_sets as _section_phase_sets
from bvphoenix.api.studies import phases as _section_phases
...
from bvphoenix.api.studies.phase_sets import *  # noqa: F403
from bvphoenix.api.studies.phases import *  # noqa: F403
...
router.include_router(_section_phases.router)
router.include_router(_section_phase_sets.router)
